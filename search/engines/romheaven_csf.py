    ...
    for pair_ in games_filtered:
        ...
        for type in ["pixeldrain", "buzzheavier", "direct"]:
            ...
            yield {
                ...
                "LinkUrl": "https://pixeldrain.com/u/" + game["pixeldrain"] if type == "pixeldrain" else ("https://buzzheavier.com/f/" + game["buzzheavier"] if type == "buzzheavier" else f"https://dl.romheaven.com/{game['appid']}.rar?filename=" + urllib.parse.quote(f"{game['appid']}) {game['install_dir']}.rar")),
                "LinkType": "Direct",
