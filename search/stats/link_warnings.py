...
class NotRecommendedFilehost(Enum): # more can be added, there are just some more used ones
    ...
    OneFichier = 3 # annoying limitations
    Qiwi = 4 # with their migration to ranoz.gg, qiwi links don't work 
    ZippyShare = 5 # shut down
    PixelDrain = 6 # is good in terms of speed, has a download limit though - can be bypassed
