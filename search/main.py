...
import engines.cg_gamespc
import engines.worldofpcgames
import engines.getfreegames
import engines.oldgamesdownload
...
all_engines = [
    ...
    engines.cg_gamespc,
    engines.gamepcfull,
    engines.worldofpcgames,
    engines.getfreegames,
    engines.releasebb, 
    engines.elamigos,
    engines.oldgamesdownload,
